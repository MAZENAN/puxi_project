		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="paper_add('《{{$periodical->title}}》:写论文','/admin/periodicalPaper/add','{{$periodical->id}}')" href="javascript:;" title="写论文"><span class="btn btn-secondary-outline radius" ><i class="Hui-iconfont">&#xe60c;</i>写论文</span></a>
						<a style="text-decoration:none" class="ml-5" onClick="paper_show('《{{$periodical->title}}》:期数列表','/admin/periodicalPaper/phase','{{$periodical->id}}')" href="javascript:;" title="读论文"><span class="btn btn-success-outline radius" ><i class="Hui-iconfont">&#xe720;</i>读论文</span></a>
					</td>
				</tr>
				@endforeach
			</tbody>
...
/*论文-查看*/
function paper_show(title,url,id){

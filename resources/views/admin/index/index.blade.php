		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a data-href="{{url('admin/manager/index')}}" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-tongji">
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="{{asset('admin/index/welcome')}}">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="{{asset('admin/index/welcome')}}"></iframe>
	</div>
</div>
</section>
...
function myselfinfo(){
	layer.open({
		...
		shade:0.4,
		title: '查看信息',
		content: '<div>管理员信息</div><div>{{Auth::guard('admin')->user()->username}}</div><div>{{Auth::guard('admin')->user()->username}}</div><div>{{Auth::guard('admin')->user()->username}}</div>'
	});
}
...
/*期刊-添加*/
function periodical_add(title,url){
	var index = layer.open({
		type: 2,
		title: title,
		content: url

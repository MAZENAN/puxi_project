...
<div class="page-container">
	<form class="form form-horizontal" id="form-periodicalDoc-add" action="{{url('admin/periodicalDoc/doAdd')}}" method="post">
		<div class="row cl">
...
<!-- 上传表单 -->
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文档上传：<a href="javascript:void(0);" onClick="help(5)"><i class="Hui-iconfont" id="help5">&#xe633;</i></a></label>
            <div class="formControls col-xs-8 col-sm-9">
...
if ($("input[name='name']").val()=="") {
    ...
    return;
				...
				$(form).ajaxSubmit({
				type: 'post',
				url: "{{url('admin/periodicalDoc/doAdd')}}" ,
				success: function(data){
					if (data==1) {
						layer.msg('添加文档成功',{icon:1,time:1000},function(){
							var index = parent.layer.getFrameIndex(window.name);
                            parent.window.location = parent.window.location;
						})
					}else{
						layer.msg('添加文档失败!',{icon:2,time:2000});
					}
				},

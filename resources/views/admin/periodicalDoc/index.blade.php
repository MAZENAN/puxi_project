		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td><img width="100" class="picture-thumb" src="{{$periodical->imageUrl()}}" ></td>
					<td class="text-l">{{$periodical->title}}</td>
					...
					<td class="td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="doc_add('《{{$periodical->title}}》:文档上传','/admin/periodicalDoc/add','{{$periodical->id}}')" href="javascript:;" title="上传期刊"><span class="btn btn-secondary-outline radius" ><i class="Hui-iconfont">&#xe642;</i>上传期刊</span></a>
						<a style="text-decoration:none" class="ml-5" onClick="doc_add('文档下载','/admin/periodicalDoc/download','{{$periodical->id}}')" href="javascript:;" title="下载期刊"><span class="btn btn-success-outline radius" ><i class="Hui-iconfont">&#xe641;</i>下载期刊</span></a>
					</td>
				</tr>
				@endforeach
			</tbody>

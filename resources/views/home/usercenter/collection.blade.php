...
<link rel="stylesheet" href="/home/css/collection.css">
		...
		<div class="order_content">
			...
			<ul class="order_lists">
				<li class="list_con">
					...
					<div class="list_text"><a href="/paper/{{$paper->code}}{{config('myroute.suffix','html')}}" target="_back"> {{$paper->title}}</a></div>
				</li>
				<li class="list_info">
					<p>{{$paper->abstract}}</p>
				</li>
		...
		$('.dialog-sure').click(function () {
			if (current_id!=-1){
				$.ajax(
						{
							type:"POST",
							url:"/usercenter/removeCollected",
							data:"_token={{csrf_token()}}&id="+current_id,
